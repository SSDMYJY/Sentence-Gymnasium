<template>
  <Menu as="div" class="relative">
    <MenuButton
      class="inline-flex items-center rounded-full border border-white/10 p-2 text-xs text-stone-300 transition-colors hover:border-white/30 hover:text-white"
